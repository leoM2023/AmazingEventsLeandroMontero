...
function generarContenidoUpcoming(arregloEventos, fechaActual) {
    let listaDeTarjetas = ""
    ...
    contenedorDeTarjetas.innerHTML = generarContenidoUpcoming(data.events, data.currentDate)
    ...
    function refrescarContenido(contenedorDeTarjetas) {
        ...
        contenedorDeTarjetas.innerHTML = generarContenidoUpcoming(listaEventos, data.currentDate);
    }    
